...
const Login = () => {
  ...
  const { loginUser, signInWithGoogle } = useAuth(); // Ensure the correct method name
  ...
  const handleGoogleSignIn = async () => { // Added 'async' keyword
    try {
  ...
  return (
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
      <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
        ...
        <p className='align-baseline font-medium mt-4 text-sm'>Have no account? Please  
        ...
        <div className='mt-4'>
          <button
            ...
            bg-[#FFD700] hover:bg-[#E6BE00] text-white font-bold py-2 px-4 rounded focus:outline-none'>
