...
import { useAuth } from '../contex/AuthContex'; // Ensure this path is correct
...
const Register = () => {
  ...
  const onSubmit = async (data) => { // Added 'async' keyword
    console.log(data);
    try {
      await registerUser(data.email, data.password); // Await registerUser
