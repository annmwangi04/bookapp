...
import bannerImg from "../../assets/News/banner.png"; // Corrected image path
  ...
  return (
    <div className='flex flex-col md:flex-row reverse py-16 justify-between items-center gap-12'>
        <div className='md:1/2 w-full'>
            ...
            <button className='bg-[#FFDB58] text-white py-2 px-4 rounded-md hover:bg-yellow-500'>Subscribe</button>
        </div>
